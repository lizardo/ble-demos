...
/*
 * Implementation of interface class DuiControlPanelIf
 */

DuiControlPanelIf::DuiControlPanelIf(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
